...
class MyOfferFilterComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      scrollEnabled: true,
        ...
        <ScrollView style={styles.selectFilterCategoriesInner}>
          <View style={{ paddingLeft: 20, paddingBottom: 10, paddingTop: 10 }}>
            ...
            <List.Item
              ...
              description="Select Published option"
              right={(props) => (
                <RadioButton
            ...
            <List.Item
              ...
              description="Select Draft option"
              right={(props) => (
                <RadioButton
                  color={color.primaryColor}
                  style={styles.TopicPageCheckboxes}
            ...
            <List.Item
              ...
              description="Select Completed option"
              right={(props) => (
                <RadioButton
                  color={color.primaryColor}
                  style={styles.TopicPageCheckboxes}
            ...
            <List.Item
              ...
              description="Select Expired option"
              right={(props) => (
                <RadioButton
                  color={color.primaryColor}
                  style={styles.TopicPageCheckboxes}
                  status={this.props.filter_id === 4 ? "checked" : "unchecked"}
                  onPress={() => {
                    this.filter(4, "Expired");
                  }}
                />
            ...
            <List.Item
              ...
              description="Select Canceled"
              right={(props) => (
                <RadioButton
                  color={color.primaryColor}
                  style={styles.TopicPageCheckboxes}
                  status={this.props.filter_id === 5 ? "checked" : "unchecked"}
                  onPress={() => {
                    this.filter(5, "Canceled");
                  }}
                />
...
export default MyOfferFilterComponent;
