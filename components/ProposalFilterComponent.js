...
class ProposalFilterComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      scrollEnabled: true,
        ...
        <ScrollView style={styles.selectFilterCategoriesInner}>
          <View style={{ paddingLeft: 20, paddingBottom: 10, paddingTop: 10 }}>
            ...
            <List.Item
              ...
              description="Select Invitations to see"
              right={(props) => (
                <RadioButton
            ...
            <List.Item
              ...
              description="Select Applied to see"
              right={(props) => (
                <RadioButton
                  color={color.primaryColor}
                  style={styles.TopicPageCheckboxes}
...
export default ProposalFilterComponent;
