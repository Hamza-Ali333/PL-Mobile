...
class VideoAttachmentHeader extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        modalVisible: false,
  ...
  YourAttachmentScreenNavigate =(props) =>{
      this.props.navigation.navigate("YourAttachment");
    }
  YourVideoScreenNavigate =(props) =>{
    ...
    return (
        <View>
          <TouchableOpacity style={{flex:1,flexDirection: 'row',alignItems: 'center'}} onPress={this.showModal}>
              <Text style={styles.postQuestionPageTitle}>Your Video</Text>
              <Image
                 ...
                 <Text style={styles.popUpHeading}>What do you want?</Text>
                  <TouchableOpacity style={styles.modalCloseIcon}
                   onPress={this.hideModal}>
                    ...
                    onPress={this.YourAttachmentScreenNavigate}>
                      <Text style={{
                        fontSize: 15,
                    ...
                    <TouchableOpacity style={styles.BottomOptionListItems}
                    onPress={this.YourVideoScreenNavigate}>
                      <Text style={{
                        fontSize: 15,
                        fontFamily: FontFamily.Regular,
                        color: color.blackColor,
...
export default VideoAttachmentHeader;
