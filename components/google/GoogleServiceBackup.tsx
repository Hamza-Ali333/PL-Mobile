...
const ACCESS_TOKEN_URL: string = "https://oauth2.googleapis.com/token";
const LOGOUT_URL: string = "https://www.google.com/accounts/Logout";
...
export default class GoogleModal extends React.Component<Props, State> {
  static propTypes = {
  ...
  componentDidUpdate(nextProps: Props, nextState: State) {
    if (
      ...
      const authState = nextProps.authState || uuid.v4();
  ...
  render() {
    ...
    const { animationType, containerStyle, wrapperStyle, closeStyle } =
      this.props;
    return (
      <View>
        {/*this.renderButton()*/}
