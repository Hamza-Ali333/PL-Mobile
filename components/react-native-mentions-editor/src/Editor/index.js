...
export class Editor extends React.Component {
  ...
  //   if(nextState.editorHeight<this.state.editorHeight){
  //     return false;
  //   }
  //   return true;
  // }
  ...
  updateSuggestions(lastKeyword) {
    ...
    this.sendTriggerChange(lastKeyword);
  }
  ...
  resetTextboxHeight() {
    this.setState({ editorHeight: this.props.editorHeight });
  }
  ...
  sendTriggerChange(text) {
    this.props.onTriggerChange(text.substr(1));
  }
  ...
  onContentSizeChange = (evt) => {
     ...
     */
    if (evt.nativeEvent.contentSize.height > this.props.editorHeight) {
      if (evt) {
          ...
          >
            <View style={[{ height: this.state.editorHeight }]}>
              <TextInput
                ...
                multiline={this.props.disabledMultiline ? false : true}
