...
export default class WebPreview extends React.PureComponent {
  ...
  componentDidMount() {
    if (this.props.item.description !== null) {
      this.getPreview(this.props.item.description);
    } else {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.item.description !== null) {
      this.getPreview(nextProps.item.description);
    } else {
      this.setState({ isUri: false });
    }
  }
  ...
  _onLinkPressed = async () => {
    let meta = this.props.item.description;
