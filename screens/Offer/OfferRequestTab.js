...
import getOfferRequests from "../../graphql/queries/getOfferRequests";
...
class OfferRequestTab extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <ScrollView>
            ...
            >
              Following is the all Invitations
            </Text>
            <Query
              query={getOfferRequests}
            ...
            >
              {({ loading, error, data, fetchMore, refetch }) => {
                ...
                if (data.offer.requests.length > 0) {
                  return data.offer.requests.map((item, key) => {
