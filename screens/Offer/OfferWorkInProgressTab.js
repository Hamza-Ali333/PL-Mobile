...
import getOfferWorkInProgress from "../../graphql/queries/getOfferWorkInProgress";
...
class OfferWorkInProgressTab extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <ScrollView>
            ...
            >
              Following is the Work In Progress
            </Text>
            <Query
              query={getOfferWorkInProgress}
            ...
            >
              {({ loading, error, data, fetchMore, refetch }) => {
                ...
                if (data.offer.workInProgress.length > 0) {
                  return data.offer.workInProgress.map((item, key) => {
...
export default OfferWorkInProgressTab;
