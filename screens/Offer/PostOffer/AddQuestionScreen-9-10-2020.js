...
class AddQuestionScreen extends React.Component {
  ...
  addTextInput = (index, value) => {
    ...
    textInput.push(
      <View
        ...
        key={index}
      >
        <Text style={styles.dateRangeText}>Question {index + 1}</Text>
        <View style={{}}>
          <TextInput
  ...
  removeTextInput = () => {
    ...
    inputData.pop();
    questions.pop();
    this.setState({ textInput, inputData, questions });
  };
      ...
      <KeyboardAwareScrollView>
        ...
        >
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View>
              {this.state.inputData.map((value) => {
                ...
                return (
                  ...
                  >
                    <Text style={styles.dateRangeText}>Question {index}</Text>
                    <Text style={styles.addQuestionDescription}>
                      {value.text}
                    </Text>
                  </View>
                );
